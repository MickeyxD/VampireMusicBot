...
OWNER_NAME = getenv("OWNER_NAME", "MickeyxD")
ALIVE_NAME = getenv("ALIVE_NAME", "MickeyxD")
BOT_USERNAME = getenv("BOT_USERNAME", "camillamusicbot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "VampireBot_Network")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "VampireBot")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Vampire_Network")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/MickeyxD/video-stream")
